...
public class SystemConfig {
   ...
   public static SystemConfig getInstance() {
    ...
    SystemConfig() {
        ...
        readPermissions(Environment.buildPath(Environment.getVendorDirectory(), "etc", "sysconfig"), vendorPermissionFlag);// 		/verdor/etc/sysconfig   //目录不存在，暂时忽略
