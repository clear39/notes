...
static void addHyphenator(const std::string& locale, int minPrefix, int minSuffix) {
    ...
    minikin::addHyphenator(locale, minikin::Hyphenator::loadBinary(ptr, minPrefix, minSuffix, locale));
}


static void addHyphenatorWithoutPatternFile(const std::string& locale, int minPrefix,int minSuffix) {
    minikin::addHyphenator(locale, minikin::Hyphenator::loadBinary(nullptr, minPrefix, minSuffix, locale));
}
